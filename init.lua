...
-- Using JetBrains Mono NFM (Regular 13)
      ...
      vim.keymap.set('n', '<leader><leader>', function()
        builtin.buffers {
          sort_buffers = function(bufnr_a, bufnr_b)
            local path_a = vim.api.nvim_buf_get_name(bufnr_a)
            local path_b = vim.api.nvim_buf_get_name(bufnr_b)
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- vim.api.nvim_set_keymap('n', '<Leader>d', ':execute "tabe+" .. vim.fn.line(".") .. " %"<CR>gT', { noremap = true, silent = true })
